                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="${base}/admin"><i class="fa fa-home"></i> 文章管理</a>
                            <li><a href="${base}/admin"><i class="fa fa-home"></i> 用户管理</a>
                            <li><a href="${base}/admin"><i class="fa fa-home"></i> 评论管理</a>
                            <li><a href="${base}/admin"><i class="fa fa-home"></i> 栏目管理</a>
                            </li>
                            <%--<@menus>
